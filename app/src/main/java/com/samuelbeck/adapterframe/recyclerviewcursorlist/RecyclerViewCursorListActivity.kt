...
import com.samuelbeck.adapterframe.recyclerviewcursorlist.RecyclerViewCursorListAdapter.RecyclerCursorListAdapterInterface
...
class RecyclerViewCursorListActivity: AppCompatActivity() {

    private lateinit var adapter: RecyclerViewCursorListAdapter
    lateinit var layoutManager: LinearLayoutManager
    lateinit var viewModel: RecyclerViewCursorListViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = RecyclerViewCursorListAdapter(adapterInterface, null)

        recycler_view.layoutManager = layoutManager
        recycler_view.adapter = adapter

        viewModel = ViewModelProviders.of(this).get(RecyclerViewCursorListViewModel::class.java)
